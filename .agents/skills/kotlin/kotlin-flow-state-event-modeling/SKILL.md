...
- [`compose-side-effects`](../../compose-multiplatform/compose-side-effects/SKILL.md) — collecting event flows and wiring side effects in Compose
- [`compose-state-holder-ui-split`](../../compose-multiplatform/compose-state-holder-ui-split/SKILL.md) — where state holders expose flows to UI
