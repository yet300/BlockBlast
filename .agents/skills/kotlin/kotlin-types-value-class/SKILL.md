...
- [`compose-stability-diagnostics`](../../compose-multiplatform/compose-stability-diagnostics/SKILL.md) — diagnose unstable Compose parameters; value classes are one fix
