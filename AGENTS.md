...
| `:miniapp:audio` | Procedural Music/SFX declarations, typed lookups and commands, plus pure compile-time validation with structured diagnostics; DSP and playback are staged | `:core:pattern`, `:miniapp:api`, `:core:common`, `:core:domain`; no Compose or feature dependency |
